...
const setupAdmin = () => {
    alert("setup del admin");
    const dashboardLink = document.querySelector("a[href='/src/views/dashboard.html']");
    if (dashboardLink) {
        ...
        alert("no se encontro el link del dashboard");
    }
}
